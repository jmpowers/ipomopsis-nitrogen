...
megameta <- bind_rows(greenhouse=meta, .id = "experiment", field=meta.field %>% mutate(treatment=as.character(recode(treatment,`water control` = "low",control="low", nitrogen="high")), time=as.character(time), species= as.character(recode(species, Ihyb="ten", Lagg="agg")))) 
...
#no significant p values :(
  ...
  #c("LaggDhigh - LaggDlow == 0","LaggNhigh - LaggNlow == 0", "IhybNhigh - IhybNlow == 0", "IhybDhigh - IhybDlow==0"))))
